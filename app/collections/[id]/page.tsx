...
const ProductById = async ({ params }: IParams) => {
  ...
  return (
    <div className="flex flex-col  h-4/5 items-center sm:flex-row gap-x-14 gap-y-10 w-full sm:items-start mt-10 px-5 md:gap-20 pb-10">
      <div className="flex self-center relative w-3/5 sm:w-1/2 md:w-1/3 aspect-[1/1]">
